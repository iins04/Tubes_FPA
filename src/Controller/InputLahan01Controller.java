 ...
 * @author USER HP
 */
public class InputLahan01Controller implements Initializable {
    ...
    InputLahanList data;
    String nmPemilik,lokasi,jenis,modelSewa;
    
    ObservableList<String> cbList = FXCollections.observableArrayList
        ("Ngaglik","Ngemplak","Imogiri","Jetis","Godean","Wates","KotaGede");
    ...
    private void inputButtonAction(ActionEvent event){
        ...
        lokasi = (String) chbLokasi.getValue();
        ...
        data.setData(nmPemilik,lokasi, jenis, modelSewa);
    ...
    void hbHapusAction (ActionEvent event) throws IOException {
        ...
        if (selectedIndex >= 0) {
            tvDataBase.getItems().remove(selectedIndex);
        }
    }
